                    ...
                    <table id="facarticulo">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th style="text-align:right;">S/. {{editedItem.totalParcial = (editedItem.total - editedItem.totalImpuesto).toFixed(2)}}</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th style="text-align:right;">IVA ({{editedItem.impuesto}}%)</th>
                                <th style="text-align:right;">S/. {{editedItem.totalImpuesto = ((editedItem.total * editedItem.impuesto) / (1+editedItem.impuesto)).toFixed(2)}}</th>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
